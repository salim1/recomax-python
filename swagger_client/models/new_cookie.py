...
class NewCookie(object):
    ...
    def __init__(self, comment=None, domain=None, expiry=None, http_only=None, max_age=None, name=None, path=None, secure=None, value=None, version=None, _configuration=None):  # noqa: E501
