...
class Locale(object):
    ...
    def __init__(self, country=None, display_country=None, display_language=None, display_name=None, display_script=None, display_variant=None, extension_keys=None, iso3_country=None, iso3_language=None, language=None, script=None, unicode_locale_attributes=None, unicode_locale_keys=None, variant=None, _configuration=None):  # noqa: E501
